...
//    private float scaleX;//设置缩放比例
    ...
    private OnceAnimListener onceAnimListener;

    public void setOnceAnimListener(OnceAnimListener listener)
    {
        this.onceAnimListener = listener;
    }

    public interface OnceAnimListener
    {
        void onlyOnceStop();
    }
